export class Person {
    constructor({ 
        ...
        if (typeof created_at !== 'string') throw new Error('Parameter "created_at" must be "date" type');
        if (typeof updated_at !== 'string') throw new Error('Parameter "updated_at" must be "date" type');
        

        this.id = id;
        this.first_name = first_name;
        this.lastN_name = last_name;
